 ...
 */
export function toScale(year, mode, min = GLOBAL_MIN, max = GLOBAL_MAX) {
 ...
 */
export function fromScale(pos, mode, min = GLOBAL_MIN, max = GLOBAL_MAX) {
    let t;
    switch (mode) {
        case "linear":
            t = pos;
 ...
 */
export function toPct(year, mode, min = GLOBAL_MIN, max = GLOBAL_MAX) {
 ...
 */
export function getPlayStep(year) {

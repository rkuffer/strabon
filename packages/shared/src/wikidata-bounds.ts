 ...
 */
export function buildBoundsQuery(qids: string[]): string {
 ...
 */
export function parseBoundsRows(rows: any[]): Map<string, WikidataBounds> {
  const out = new Map<string, WikidataBounds>();
